...
def main():
    ...
    try:
        ...
        print(f"   ⚠️ Aviso: Erro ao instalar bibliotecas: {e}")
    
    # Executar o código principal
    try:
        print("\n2. Executando análise de estoque...")
...
def execute_stock_analysis():
    ...
    print("📊 ANÁLISE COMPLETA DE ESTOQUE")
    print("=" * 60)
    ...
    for file_path in data_files:
        if os.path.exists(file_path):
            try:
                ...
                print(f"✅ Dados carregados: {file_path}")
    ...
    if df is None:
        ...
        print("⚠️ Nenhum arquivo de dados encontrado. Criando dados de exemplo...")
    ...
    if numeric_cols:
        ...
        print(f"✅ Estatísticas salvas em: {output_dir}/estatisticas_basicas.csv")
...
def create_basic_visualizations(df, output_dir):
    ...
    if potential_qty_cols:
        ...
        plt.title(f'Distribuição de {qty_col}')
        plt.xlabel(qty_col)
        ...
        print(f"✅ Gráfico salvo: distribuicao_quantidade.png")
    ...
    if potential_val_cols:
        ...
        plt.title(f'Distribuição de {val_col}')
        plt.xlabel(val_col)
        plt.ylabel('Frequência')
        ...
        print(f"✅ Gráfico salvo: distribuicao_valor.png")
...
def create_summary_report(df, loaded_file, output_dir):
    ...
    print(f"✅ Relatório salvo: relatorio_resumo.json")
